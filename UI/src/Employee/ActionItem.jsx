...
export default class ActionItem extends Component {
    ...
    renderTableHeader() {
        let header = ["Application Id", "Student Id", "Name", "Status", "Employer Form", "Advisor Form", "Action", "Submit"]
            ...
            return (
                <>
                    <tr key={index}>
                        ...
                        <td>
                            <Base64Downloader base64={employer_form} downloadName="pdfDownload_emp" onDownloadSuccess={() => (this.setState({empForm: "true"}))}>
                                Click to download Employer Form
                            </Base64Downloader>
                        </td>
                        <td>
                            <Base64Downloader base64={advisor_form} downloadName="pdfDownload_adv" onDownloadSuccess={() => (this.setState({advForm: "true"}))}>
                            ...
                            <button
                                ...
                                onClick={
                                    async (e) => {
                                        ...
                                        if (this.state.empForm.length != 0 && this.state.advForm.length != 0) {
